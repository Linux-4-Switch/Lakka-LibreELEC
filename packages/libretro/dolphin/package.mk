...
if [ "$PROJECT" == "L4T" ]; then
  PKG_CMAKE_OPTS_TARGET="-DENABLE_X11=ON -DLIBRETRO=ON -DENABLE_VULKAN=ON -DENABLE_NOGUI=OFF -DENABLE_QT=OFF -DENABLE_TESTS=OFF -DUSE_DISCORD_PRESENCE=OFF -DBUILD_SHARED_LIBS=OFF -DCMAKE_BUILD_TYPE=Release"
else
