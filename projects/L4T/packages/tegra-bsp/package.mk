...
makeinstall_target() {
  ...
  ln -sfn libnvv4l2.so libv4l2.so
  ln -sfn libnvv4l2.so libv4l2.so.0.0.999999
  ln -sfn libnvv4lconvert.so libv4lconvert.so
  ...
  ln -sfn  libnvidia-ptxjitcompiler.so.${PKG_VERSION} libnvidia-ptxjitcompiler.so.1
  ...
  cd ../share/glvnd/egl_vendor.d/
  ln -snf /usr/lib/nvidia.json 10_nvidia.json
  cd ../../../lib
  ...
  #Symlink vulkan icd to proper place
  cd vulkan/icd.d
  rm nvidia_icd.json
