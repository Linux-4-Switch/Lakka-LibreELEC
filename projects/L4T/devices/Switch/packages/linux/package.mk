...
PKG_DEPENDS_TARGET="toolchain cpio:host kmod:host pciutils repo:host xz:host wireless-regdb keyutils $L4T_DEPENDS"
...
KERNEL_DIR=$BUILD/$PKG_NAME-$PKG_VERSION/kernel/kernel-4.9
...
makeinstall_host() {
  if [ $TARGET_KERNEL_ARCH = "arm64" ] && [ $TARGET_ARCH == "arm"  ]; then
    make -C $KERNEL_DIR ARCH=$TARGET_ARCH headers
